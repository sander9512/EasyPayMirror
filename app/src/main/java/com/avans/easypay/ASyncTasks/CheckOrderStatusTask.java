...
public class CheckOrderStatusTask extends AsyncTask<String, Void, String> {
    ...
    private static final String TAG = CheckOrderStatusTask.class.getSimpleName();
    private OnStatusAvailable listener = null;

    public CheckOrderStatusTask(OnStatusAvailable listener) {
    ...
    protected void onPostExecute(String response) {
        ...
        try {
            ...
            if (order != null) {
                ...
                //call back with order status that was been searched for
                listener.onStatusAvailable(status);
            } else {
                //return null if no order was found
                listener.onStatusAvailable(null);
            }
